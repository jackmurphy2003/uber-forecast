...
export default function NotesPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Header />
      <main className="flex-1 px-6 md:px-10 py-8 md:py-14 pb-24 md:pb-14 max-w-[860px] w-full mx-auto flex flex-col gap-10">

        <div>
          <h1 className="text-[28px] font-black tracking-tight mb-2" style={{ color: "#0A0A0A" }}>
            Notes
          </h1>
          <p className="text-[13px] leading-relaxed" style={{ color: "#6B6B6B" }}>
            Sources, model logic, and known caveats for the Q2&apos;26F forecast, submitted ahead of Uber&apos;s August 5, 2026 earnings.
          </p>
        </div>

        {/* Data sources */}
        <section>
          <h2 className="text-[17px] font-extrabold tracking-tight mb-1" style={{ color: "#0A0A0A" }}>
            Data Sources
          </h2>
        ...
        {/* Driver tree */}
        <section>
          <h2 className="text-[17px] font-extrabold tracking-tight mb-4" style={{ color: "#0A0A0A" }}>
            Model Logic
          </h2>
        ...
        {/* EBITDA scenarios */}
        <section>
          <h2 className="text-[17px] font-extrabold tracking-tight mb-3" style={{ color: "#0A0A0A" }}>
      ...
      <footer
        className="flex-none px-6 pb-24 md:pb-10 pt-8 text-center max-w-[860px] w-full mx-auto"
